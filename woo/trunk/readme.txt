...
Enhance WooCommerce checkout with dynamic field customization, conditional logic, and an intuitive settings panel.
...
1. Upload the plugin files to the `/wp-content/plugins/billing-process-engineering` directory, or install directly through the WordPress plugins screen.
2. Activate the plugin via the 'Plugins' screen in WordPress.
3. Navigate to **BPE Woo Settings** in the WordPress admin panel to configure plugin options.
...
== Upgrade Notice ==
Make sure to review and configure the settings after upgrading to ensure the new features meet your requirements.
